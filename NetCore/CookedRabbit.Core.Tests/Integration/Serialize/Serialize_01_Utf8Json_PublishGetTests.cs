...
namespace CookedRabbit.Core.Tests.Integration
{
    ...
    public class Serialize_02_Utf8Json_PublishGetTests
    {
        private readonly Utf8_NoCompression _fixture;

        public Serialize_02_Utf8Json_PublishGetTests(Utf8_NoCompression fixture)
        {
            _fixture = fixture;
        }
