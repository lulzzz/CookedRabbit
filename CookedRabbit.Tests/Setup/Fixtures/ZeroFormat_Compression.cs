...
{
    [CollectionDefinition("IntegrationTests_Compression_ZeroFormat")]
    public class IntegrationCollection_Compression_ZeroFormat : ICollectionFixture<ZeroFormat_Compression>
    { }

    public class ZeroFormat_Compression : IDisposable
    {
