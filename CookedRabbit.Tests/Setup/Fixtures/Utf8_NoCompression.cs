...
{
    [CollectionDefinition("IntegrationTests_NoCompression_Utf8")]
    public class IntegrationCollection_NoCompression_Utf8 : ICollectionFixture<Utf8_NoCompression>
    { }

    public class Utf8_NoCompression : IDisposable
    {
