...
using static CookedRabbit.Demo.RabbitServiceCompressionExamples; // Simple Compression and Decompression.
using static CookedRabbit.Demo.RabbitServiceSerializationExamples;
